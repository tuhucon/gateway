...
public final class SessionBundleConfigOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getSessionTarget()
          .equals(other.getSessionTarget())) return false;
      if (hasSessionConfig() != other.hasSessionConfig()) return false;
      if (hasSessionConfig()) {
        if (!getSessionConfig()
            .equals(other.getSessionConfig())) return false;
      }
      if (hasBatchingParameters() != other.hasBatchingParameters()) return false;
      if (hasBatchingParameters()) {
        if (!getBatchingParameters()
            .equals(other.getBatchingParameters())) return false;
      }
      if (hasSessionRunLoadThreadpoolIndex() != other.hasSessionRunLoadThreadpoolIndex()) return false;
      if (hasSessionRunLoadThreadpoolIndex()) {
        if (!getSessionRunLoadThreadpoolIndex()
            .equals(other.getSessionRunLoadThreadpoolIndex())) return false;
      }
      if (getExperimentalTransientRamBytesDuringLoad()
          != other.getExperimentalTransientRamBytesDuringLoad()) return false;
      if (!getSavedModelTagsList()
          .equals(other.getSavedModelTagsList())) return false;
      if (!getExperimentalFixedInputTensorsList()
          .equals(other.getExperimentalFixedInputTensorsList())) return false;
      if (getEnableModelWarmup()
          != other.getEnableModelWarmup()) return false;
  ...
  private static final long serialVersionUID = 0L;
    ...
    private BatchingParameters() {
      allowedBatchSizes_ = emptyLongList();
    }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 48: {
              if (!((mutable_bitField0_ & 0x00000020) != 0)) {
                allowedBatchSizes_ = newLongList();
                mutable_bitField0_ |= 0x00000020;
              }
              allowedBatchSizes_.addLong(input.readInt64());
              break;
            }
            case 50: {
        ...
        if (((mutable_bitField0_ & 0x00000020) != 0)) {
          allowedBatchSizes_.makeImmutable(); // C
        }
        this.unknownFields = unknownFields.build();
        makeExtensionsImmutable();
      }
    ...
    private com.google.protobuf.Internal.LongList allowedBatchSizes_;
    /**
     * <pre>
     * The allowed batch sizes. (Ignored if left empty.)
     * Requirements:
    ...
    public long getAllowedBatchSizes(int index) {
      return allowedBatchSizes_.getLong(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < allowedBatchSizes_.size(); i++) {
        output.writeInt64NoTag(allowedBatchSizes_.getLong(i));
      }
      ...
      }
      {
        ...
        for (int i = 0; i < allowedBatchSizes_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeInt64SizeNoTag(allowedBatchSizes_.getLong(i));
        }
        size += dataSize;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (hasMaxBatchSize()) {
        if (!getMaxBatchSize()
            .equals(other.getMaxBatchSize())) return false;
      }
      if (hasBatchTimeoutMicros() != other.hasBatchTimeoutMicros()) return false;
      if (hasBatchTimeoutMicros()) {
        if (!getBatchTimeoutMicros()
            .equals(other.getBatchTimeoutMicros())) return false;
      }
      if (hasMaxEnqueuedBatches() != other.hasMaxEnqueuedBatches()) return false;
      if (hasMaxEnqueuedBatches()) {
        if (!getMaxEnqueuedBatches()
            .equals(other.getMaxEnqueuedBatches())) return false;
      }
      if (hasNumBatchThreads() != other.hasNumBatchThreads()) return false;
      if (hasNumBatchThreads()) {
        if (!getNumBatchThreads()
            .equals(other.getNumBatchThreads())) return false;
      }
      if (hasThreadPoolName() != other.hasThreadPoolName()) return false;
      if (hasThreadPoolName()) {
        if (!getThreadPoolName()
            .equals(other.getThreadPoolName())) return false;
      }
      if (!getAllowedBatchSizesList()
          .equals(other.getAllowedBatchSizesList())) return false;
      if (getPadVariableLengthInputs()
          != other.getPadVariableLengthInputs()) return false;
      if (!unknownFields.equals(other.unknownFields)) return false;
      return true;
    }
    ...
    public static final class Builder extends
      ...
      private com.google.protobuf.Internal.LongList allowedBatchSizes_ = emptyLongList();
      private void ensureAllowedBatchSizesIsMutable() {
        if (!((bitField0_ & 0x00000020) != 0)) {
          allowedBatchSizes_ = mutableCopy(allowedBatchSizes_);
          bitField0_ |= 0x00000020;
         }
      }
      /**
      ...
      public java.util.List<java.lang.Long>
        ...
        return ((bitField0_ & 0x00000020) != 0) ?
                 java.util.Collections.unmodifiableList(allowedBatchSizes_) : allowedBatchSizes_;
      }
      /**
       * <pre>
       * The allowed batch sizes. (Ignored if left empty.)
      ...
      public Builder setAllowedBatchSizes(
        ...
        ensureAllowedBatchSizesIsMutable();
        allowedBatchSizes_.setLong(index, value);
        onChanged();
        return this;
      }
      /**
      ...
      public Builder addAllowedBatchSizes(long value) {
        ensureAllowedBatchSizesIsMutable();
        allowedBatchSizes_.addLong(value);
        onChanged();
        return this;
      }
      /**
